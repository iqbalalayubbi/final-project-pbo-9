...
public class PersediaanUbah extends javax.swing.JFrame {
    ...
    public PersediaanUbah(DashboardUI parentUI, int idSelected, JTable requestTable) {
        ...
        this.idSelected = valuesRow.get("ID Barang");
    ...
    private void initComponents() {
        ...
        delete_btn.setPreferredSize(new java.awt.Dimension(100, 50));
    ...
    private void deletePersediaanRecord(){
        boolean success = DatabaseConnect.deleteItemTable(this.idSelected, "persediaan", "id_barang");
        if (success) {
